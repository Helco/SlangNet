...
public readonly record struct SlangResult(int RawValue)
{
    ...
    public const ushort FacilityMe = 0x300;
    ...
    public static readonly SlangResult GotNullPointer = new(false, FacilityMe, 1);
    ...
    public override string ToString()
    {
        ...
        else if (this == GotNullPointer) return nameof(GotNullPointer);
